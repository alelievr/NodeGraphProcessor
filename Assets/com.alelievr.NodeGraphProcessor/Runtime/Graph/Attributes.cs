...
namespace GraphProcessor
{
	...
	public class CustomPortBehaviorAttribute : Attribute
	{
		public string		fieldName;
		/// <summary>
		/// Allow the links to the ports generated by this attribute to be reordered if the type is the same.
		/// Set this to true if you want to create dynamic lists of one type.
		/// </summary>
		public bool			allowReordering;

		public CustomPortBehaviorAttribute(string fieldName, bool allowReordering = false)
		{
			this.fieldName = fieldName;
